...
export const metadata: Metadata = {
  ...
  description: 'Production-ready Next.js 14 + tRPC + Prisma foundation with 14 UI components, 13 database models, and demo mode. Skip setup, start building. $49 one-time.',
  ...
  openGraph: {
    ...
    description: 'Next.js 14 + tRPC + Prisma starter kit. 14 components, 13 DB models, demo mode included. $49 one-time.',
    images: [
      {
        url: '/og-image.png',
        width: 1200,
  ...
  twitter: {
    ...
    title: 'Ownly Starter Kit — Ship Your SaaS in Days',
    description: 'Next.js 14 + tRPC + Prisma foundation. 14 components, 13 models, demo mode. $49.',
    images: ['/og-image.png'],
    creator: '@cod3black',
  },
  robots: {
